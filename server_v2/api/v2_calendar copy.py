...
def sync_calendar():
    ...
    try:
        ...
        # Per le chiamate manuali dalla UI vogliamo, di default, una risincronizzazione completa.
        # Se il client non specifica force_resync, lo consideriamo True.
        if "force_resync" in data:
