...
const SimulatoreTab: React.FC = () => {
  ...
  // Debounce simulazione quando cambiano i parametri
  useEffect(() => {
  ...
  const runSimulation = async () => {
    ...
    try {
      ...
      if (res.state === 'success') {
        ...
        toast.warning(res.error || 'Errore simulazione');
      }
    } catch (err: any) {
              ...
              <CRow className="mb-4">
                <CCol xs={6}>
                  <KpiCard
                    ...
                    value={result.simulato.produzione}
                    suffix=" EUR"
                    color="#321fdb"
                  />
                </CCol>
