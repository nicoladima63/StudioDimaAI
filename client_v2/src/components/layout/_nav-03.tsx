...
const _nav = [
  ...
  {
    component: CNavGroup,
    name: 'Pazienti e appuntamenti',
    to: '/pazienti-appuntamenti',
  ...
  {
    component: CNavGroup,
    name: 'Comunicazioni paziente',
    to: '/comunicazioni-paziente',
  ...
  {
    component: CNavGroup,
    name: 'Acquisti e contabilita',
    to: '/acquisti-contabilita',
