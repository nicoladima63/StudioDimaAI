      ...
      {columnSelectorOpen && (
        ...
        >
          <div className='px-3 py-2 bg-light border-bottom'>
            ...
            <div className='small text-muted'>Seleziona le colonne da visualizzare</div>
          </div>

          <div className='px-3 py-2 bg-info-subtle border-bottom'>
            <div className='d-flex align-items-center gap-2'>
              <span>💡</span>
              <span className='small text-info'>Trascina gli header per riordinare</span>
            </div>
          </div>
              ...
              <div className='border-top p-2'>
                <div className='d-grid gap-1'>
                  <button
                    ...
                    onClick={() => {
                      console.log(
                        'Current config in localStorage:',
                        localStorage.getItem(`table-config-${tableId}`)
                      );
                      console.log('Current visible columns:', Array.from(visibleColumns));
                      console.log(
                        'Current column order:',
                        orderedColumns.map(col => col.key)
                      );
                    }}
                  >
                    <span>🐛</span>
              ...
              <CTableRow>
                {visibleColumnsData.map((column, index) => {
                  ...
                  if (column.align && column.align !== 'auto') {
                    ...
                    // fallback: se i valori tipici della colonna sono numerici o date => centro/destra
                    const sampleValue = data[0]?.[column.key];
                    headerAlign = getColumnAlignment(column, sampleValue);
                  }
